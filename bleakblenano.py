...
# Loops
#############
async def write_to_csv(connection: Connection):
    while True:
...
if __name__ == "__main__":
    ...
    data_to_file = write_to_csv
    connection = Connection(
        loop, read_characteristic, write_characteristic, data_to_file
    )
    try:
        asyncio.ensure_future(connection.manager())
        asyncio.ensure_future(write_to_csv(connection))
